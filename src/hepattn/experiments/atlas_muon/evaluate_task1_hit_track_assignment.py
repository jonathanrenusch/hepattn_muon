...
class Task1HitTrackEvaluator:
    ...
    def _run_single_evaluation(self, category_name, output_subdir):
        ...
        try:
            working_point_metrics = self.calculate_working_point_metrics([0.80, 0.85, 0.95])
    ...
    def calculate_double_matching_efficiency_by_variable_with_working_points(self, variable='pt', working_points=[0.80, 0.85, 0.95], bins=None):
    ...
    def plot_double_matching_efficiency_vs_variable_with_working_points(self, variable='pt', working_points=[0.80, 0.85, 0.95], output_subdir=None):
    ...
    def calculate_working_point_metrics(self, working_points=[0.80, 0.85, 0.95]):
    ...
    def calculate_working_point_metrics_by_variable(self, variable='pt', working_points=[0.80, 0.85, 0.95], bins=None):
    ...
    def plot_working_point_comparison_vs_variable(self, variable='pt', working_points=[0.80, 0.85, 0.95], output_subdir=None):
    ...
    def calculate_average_working_point_metrics_by_variable(self, variable='pt', working_points=[0.80, 0.85, 0.95]):
    ...
    def calculate_average_double_matching_with_working_points_by_variable(self, variable='pt', working_points=[0.80, 0.85, 0.95]):

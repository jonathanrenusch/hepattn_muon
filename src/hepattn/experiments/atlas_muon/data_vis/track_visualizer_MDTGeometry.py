...
class TrackVisualizerMDTGeometry:
    """
    ...
    def plot_muon_tracks(
        ...
        try:
            with uproot.open(self.root_file_path) as file:
                ...
                all_truth = tree["spacePoint_truthLink"].array(library="np")[
                    event_index
                ]

                all_high_x = tree["spacePoint_globEdgeHighX"].array(library="np")[event_index]
                all_high_y = tree["spacePoint_globEdgeHighY"].array(library="np")[event_index]
                all_high_z = tree["spacePoint_globEdgeHighZ"].array(library="np")[event_index]
                all_low_x = tree["spacePoint_globEdgeLowX"].array(library="np")[event_index]
                all_low_y = tree["spacePoint_globEdgeLowY"].array(library="np")[event_index]
                all_low_z = tree["spacePoint_globEdgeLowZ"].array(library="np")[event_index]
                ...
                print(
                    f"Event {event_number} (index {event_index}): Found {len(all_high_x)} space points"
                )

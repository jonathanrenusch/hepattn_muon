...
Usage::
    ...
    python create_split.py --preprocessed-dir /scratch/colliderml/p0_preprocessed
    ...
    python create_split.py --preprocessed-dir /scratch/colliderml/p0_preprocessed --dry-run
"""
